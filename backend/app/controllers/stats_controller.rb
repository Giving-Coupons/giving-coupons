...
class StatsController < ApplicationController
  def index
    redemptions = Redemption.includes(:coupon, campaign_charity: :charity).all
    ...
    @total_charities_supported = redemptions.map { |r| r.campaign_charity.charity_id }.uniq.count
  end
